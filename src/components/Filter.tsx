...
function Filter({ categories, brands }) {
    ...
    if (searchParams.get("categoryId")) {
      return searchParams
        ...
        .map((categoryId) => {
          ...
          // Handle the case where the category might not be found
          return category ? { value: +categoryId, label: category.label } : null;
        })
  ...
  function handleBrandsSelect(selectedOptions) {
    ...
    function handleCategoriesSelected(selectedOptions) {
      ...
      searchParams.set("categoryId", categoryIds.join(","));
      router.push(`/products?${searchParams.toString()}`, { scroll: false });
    }
  ...
  function handleSlider(e) {
    // alert("Please update the code.");
      ...
      setSliderChanged(true); // This will trigger the useEffect to update the URL
    }
  ...
  function handleOccasions(selectedOptions) {
    ...
    searchParams.set("occasions", selectedValues.join(","));
    router.push(`/products?${searchParams.toString()}`, { scroll: false });
  }
